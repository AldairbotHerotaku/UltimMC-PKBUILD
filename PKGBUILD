...
pkgrel=2
pkgdesc="MultiMC Cracked Minecraft launcher."
arch=('i686' 'x86_64')
...
provides=('ultimmc')
conflicts=('multimc')
# I dont know if it really makes a conflict with multimc but that is there in case there is
...
source=("git+https://github.com/UltimMC/Launcher"
